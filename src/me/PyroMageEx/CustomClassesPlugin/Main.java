...
public class Main extends JavaPlugin{
	...
	public ItemStack witherSkeletonHat() {
		ItemStack customItem = new ItemStack(Material.LEATHER_HELMET, 1);
		LeatherArmorMeta leatherMeta = (LeatherArmorMeta) customItem.getItemMeta();
		List<String> lore = new ArrayList<String>();
	...
	public ItemStack witherSkeletonChest() {
	...
	public ItemStack witherSkeletonSword() {
	...
	//Silverfish items
	public ItemStack silverfishHat() {
		ItemStack customItem = new ItemStack(Material.LEATHER_HELMET, 1);
		LeatherArmorMeta leatherMeta = (LeatherArmorMeta) customItem.getItemMeta();
		List<String> lore = new ArrayList<String>();
	...
	public ItemStack silverfishPick() {
